	...
	FGameplayEffectCustomExecutionOutput& OutExecutionOutput) const
{
	...
	for (const TTuple<FGameplayTag, FGameplayTag>& Pair : FAuraGameplayTags::Get().DamageTypesToResistances)
	{
		...
		checkf(AuraDamageStatics().TagsToCaptureDefs.Contains(ResistanceTag), TEXT("TagsToCaptureDefs doesn't contain Tag: [%s] om ExecCalc_Damage"), *ResistanceTag.ToString());
	...
	const float CriticalHitResistanceCoefficient = CriticalHitResistanceCurve->Eval(TargetCombatInterface->Execute_GetPlayerLevel(TargetAvatar));
	
	// Critical Hit Resistance reduces Cirtical Hit Chance by a certain percentage
